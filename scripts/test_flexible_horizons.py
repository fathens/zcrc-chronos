...
def test_edge_cases():
    ...
    try:
        ...
        for case in test_cases:
            ...
            # テストデータ作成
            base_time = datetime.datetime(2025, 6, 8, 0, 0, 0)
            timestamps = [base_time + datetime.timedelta(hours=i*2) for i in range(case['data_points'])]
            values = [39000 + i * 100 + (i % 3 - 1) * 300 for i in range(case['data_points'])]
...
def main():
    ...
    # 1. 複数の予測期間テスト
    success = test_multiple_horizons()
